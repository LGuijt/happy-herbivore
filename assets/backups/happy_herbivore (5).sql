...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 06 mrt 2025 om 12:35
...
(1, 'Breakfast', 'Start your day with our delicious breakfast options.', 'morning_boost'),
(2, 'Lunch&Dinner', 'Enjoy a hearty lunch or dinner with our tasty dishes', 'chickpea_wrap'),
(3, 'Sides', 'Complete your meal with our delicious side dishes.', 'sweet_potato'),
(4, 'Snacks', 'Enjoy a quick snack with our tasty options.', 'falafel_bites'),
(5, 'Dips', 'Enhance your meal with our delicious dips.', 'yoghurt_ranch'),
(6, 'Drinks', 'Quench your thirst with our refreshing drinks.', 'citrus_cooler');
...
(25, 'Green Glow Smoothie', 'Groene Gloed Smoothie', 'Smoothie éclat vert', 'Grüner Glow-Smoothie', '緑ピカピカスムージー'),
